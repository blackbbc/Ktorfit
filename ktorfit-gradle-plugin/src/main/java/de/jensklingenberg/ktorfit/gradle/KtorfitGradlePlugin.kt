...
class KtorfitGradlePlugin : Plugin<Project> {
    companion object {
        ...
        const val KTORFIT_KSP_PLUGIN_VERSION = "2.2.0-KBA-001" // remember to bump this version before any release!
        const val KTORFIT_COMPILER_PLUGIN_VERSION = "2.1.0-KBA-001"
        const val SNAPSHOT = ""
